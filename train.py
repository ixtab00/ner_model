...
ner.compile('nadam', loss='sparse_categorical_crossentropy', metrics=['accuracy'])
ner.summary()
...
ner.fit(x=[words, sents, casing], y=labels, batch_size=32, callbacks=callbacks, epochs=2, validation_split=0.1)